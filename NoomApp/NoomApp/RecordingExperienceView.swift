                ...
                NoomCard(fill: NoomTheme.ink, padding: 22) {
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        Text(timerText)
                            ...
                            .monospacedDigit()
                            .foregroundStyle(.white)
                        Text("NoomPlus keeps this session separate instead of presenting it as a Spot check or Activity. Keep the Band nearby while the SDK finishes, or cancel below.")
                            .font(.system(size: 14))
                            .foregroundStyle(.white.opacity(0.72))
                            .fixedSize(horizontal: false, vertical: true)
                    }
                ...
                VStack(spacing: 20) {
                    ...
                    VStack(spacing: 7) {
                        Text(finalizationTitle)
                            ...
                            .foregroundStyle(.white)
                        Text("Keep the Band nearby. NoomPlus is securing this session before you leave.")
                            .font(.system(size: 14))
